...
///////////////////////  Kernel Gap Filling for Entire Collection ///////////////////////
...
/////////////////////// FILTRO DE HAMPEL ///////////////////////
  ...
  var NBRmedian = nbrbands.map(function(img){
    ...
    var nextIndex = ee.Algorithms.If(index.eq(66), index, index.add(1)); 
...
///////////////////////// R-NBR /////////// 
/// Utiliza-se a coleção antes do Min NBR [ltCollection_all]
